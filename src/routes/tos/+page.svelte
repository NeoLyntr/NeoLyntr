  ...
  <CardContent>
    <Accordion>
      ...
      <AccordionItem value="item-6">
        ...
        <AccordionContent>
          <p>
            ...
            is created and operated by {PUBLIC_TOS_OWNER}. While we haven't registered formal intellectual property
            rights, we kindly ask users to respect our work. Users agree not to copy, modify, or distribute
            any part of the service without explicit permission from {PUBLIC_TOS_OWNER}.
          </p>
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-7">
        ...
        <AccordionContent>
          <p>
            ...
            {PUBLIC_TOS_OWNER} or {PUBLIC_BRAND}. This disclosure should be visible and unambiguous to avoid
            any confusion.
          </p>
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-10">
        ...
        <AccordionContent>
          <p>
            In no event shall {PUBLIC_TOS_OWNER}, its directors, employees, partners, agents, suppliers, or
